...
p <- DimPlot_scCustom(obj,
                      ...
                      colors_use = JCO_Four())
ggsave(p,
       filename = paste0(plots_dir, "brain_harmony_umap_dimplot_tissue.png"),
       units = "in", dpi = 600,
       height = 5, width = 6)
...
p <- DimPlot_scCustom(obj,
                      ...
                      colors_use = DiscretePalette_scCustomize(6,
                                                               palette = "ditto_seq"))
ggsave(p,
       filename = paste0(plots_dir, "brain_harmony_umap_dimplot_batch.png"),
       units = "in", dpi = 600,
       height = 5, width = 6)
...
p <- DimPlot_scCustom(obj,
                      ...
                      colors_use = JCO_Four())
ggsave(p,
       filename = paste0(plots_dir, "brain_harmony_umap_dimplot_group.png"),
       units = "in", dpi = 600,
       height = 5, width = 6)
...
p <- DimPlot_scCustom(obj,
                      ...
                      reduction = "harmony_umap")
ggsave(p,
       filename = paste0(plots_dir, "brain_harmony_umap_dimplot_id.png"),
       units = "in", dpi = 600,
       height = 5, width = 8)
